...
$tasks = $conn->query("SELECT t.id, t.title, t.status, t.priority, t.due_date, t.created_at,  CONCAT(u.first_name , ' ', u.last_name) AS assigned_user, u.email FROM tasks t LEFT JOIN users u ON t.assigned_to = u.id ORDER BY t.due_date ASC ");
?>
...
<div class="mt-5">
    <div class="row">
        ...
        <div class="col-md-6">
            <a class="btn btn-outline-primary float-end mb-3" href="AddEditTask.php" role="button"><i class="bi bi-plus"></i>&nbsp;New Task</a>
